...
-- -- Pre-clean duplicates in careers.onet_code before creating unique index
-- WITH ranked AS (
--   SELECT id, onet_code,
...
-- -- 1.2 career_technology
-- DO $$
-- BEGIN
--   IF NOT EXISTS (
--     SELECT 1
--     FROM information_schema.columns
--     WHERE table_schema='core' AND table_name='career_technology'
--       AND column_name='id' AND identity_generation IS NOT NULL
--   ) THEN
...
--     SELECT 1
--     FROM information_schema.columns
--     WHERE table_schema='core' AND table_name='career_ksas'
--       AND column_name='id' AND identity_generation IS NOT NULL
--   ) THEN
...
--     SELECT 1
--     FROM information_schema.columns
--     WHERE table_schema='core' AND table_name='career_wages_us'
--       AND column_name='id' AND identity_generation IS NOT NULL
--   ) THEN
