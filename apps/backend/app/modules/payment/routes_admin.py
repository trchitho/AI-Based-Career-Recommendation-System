    ...
    try:
        ...
        if status_filter:
            try:
                ...
                # Skip invalid status filter values - continue without this filter
                pass
        ...
        if payment_method:
            try:
                ...
                # Skip invalid payment method values - continue without this filter
                pass
        ...
        if date_from:
            try:
                ...
                # Skip invalid date format - continue without this filter
                pass
