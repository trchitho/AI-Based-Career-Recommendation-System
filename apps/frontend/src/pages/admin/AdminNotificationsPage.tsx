...
const AdminNotificationsPage = () => {
  ...
  const getSeverityStyle = (severity: string) => {
    const styles: Record<string, string> = {
      success: "bg-indigo-50 text-green-800 dark:bg-indigo-950 dark:text-indigo-300",
            ...
            <div className="space-y-4">
              ...
              {!newNotification.send_to_all && (
                <div>
                  ...
                  {newNotification.user_id && <p className="text-sm text-indigo-800 mt-1">Selected: User {newNotification.user_id}</p>}
                </div>
              )}
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    {!notification.is_read && (
                      <button onClick={() => markAsRead(notification.id)} className="p-2 text-gray-400 hover:text-indigo-800" title="Mark as read">
