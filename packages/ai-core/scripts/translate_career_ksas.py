...
def translate_ksa_names():
    ...
    ksa_name_translations = {
        ...
        # Abilities - Quantitative (duplicates removed - already defined above)
        # "Mathematical Reasoning": "Khả năng suy luận toán học",
        # "Number Facility": "Khả năng tính toán",
        # Abilities - Memory (duplicates removed - already defined above)
        # "Memorization": "Khả năng ghi nhớ",
        # Abilities - Perceptual (duplicates removed - already defined above)
        # "Speed of Closure": "Khả năng kết luận nhanh",
        # "Flexibility of Closure": "Khả năng kết luận linh hoạt",
        # "Perceptual Speed": "Tốc độ nhận thức",
        # Abilities - Spatial (duplicates removed - already defined above)
        # "Spatial Orientation": "Khả năng định hướng không gian",
        # "Visualization": "Khả năng hình dung",  # Duplicate - removed
        # Abilities - Attentiveness
        # "Selective Attention": "Khả năng chú ý có chọn lọc",  # Duplicate - removed
        # "Time Sharing": "Khả năng chia sẻ thời gian",  # Duplicate - removed
        ...
        # "Mathematics": "Toán học",  # Duplicate - removed (already defined in Knowledge section)
        "Science": "Khoa học",
...
def translate_ksa_descriptions():
    ...
    translated_count = 0
    for ksa_id, name, description, ksa_type, _category in ksas_to_translate:
