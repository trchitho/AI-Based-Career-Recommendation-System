...
def main():
    ...
    df_crosswalk = df_crosswalk[(df_crosswalk["onet_code"] != "") & (df_crosswalk["isco_code"] != "")]
    ...
    print("   Giữ lại tất cả nghề (bao gồm 'All Other')")
    ...
    print("   Top ISCO codes với nhiều O*NET mappings nhất:")
    ...
    try:
        ...
        existing_careers = pd.read_sql("SELECT onet_code, title_en FROM core.careers", engine)
    ...
    print("Database của bạn giờ đây đã có bảng career_mapping chứa:")
    print("● onet_code: Mã O*NET-SOC (VD: 13-2011.01 - Accountants)")
    print("● isco_code: Mã ISCO-08 (VD: 2411)")
    print("● isco_title_en: Tên nghề ISCO (VD: Accountants)")
    print("Bảng này sẽ là chìa khóa để mapping dữ liệu lương và kỹ năng từ ESCO!")
