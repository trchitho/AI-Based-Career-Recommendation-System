...
class AllOtherJobsMerger:
    ...
    def __init__(self):
        ...
        self.stats = {"current_jobs": 0, "all_other_unique": 0, "merged_total": 0, "duplicates_skipped": 0}
    ...
    def load_current_jobs(self):
        ...
        try:
            ...
            # Show sample
            print("\n📋 Sample current jobs:")
            for _i, row in self.current_jobs.head(3).iterrows():
    ...
    def load_all_other_jobs(self):
        ...
        try:
            ...
            for code in unique_onet_codes[:5]:
                title = self.all_other_jobs[self.all_other_jobs["O*NET-SOC 2019 Code"] == code]["O*NET-SOC 2019 Title"].iloc[0]
                count = len(self.all_other_jobs[self.all_other_jobs["O*NET-SOC 2019 Code"] == code])
    ...
    def create_all_other_jobs_entries(self):
        ...
        unique_all_other = self.all_other_jobs[["O*NET-SOC 2019 Code", "O*NET-SOC 2019 Title"]].drop_duplicates()
    ...
    def run(self):
        ...
        if coverage_ok:
            ...
            print("   Ready for next step: Translation and tagging")
        else:
            print("\n⚠️  Merge completed with coverage issues")
            print("   Review missing codes before proceeding")
