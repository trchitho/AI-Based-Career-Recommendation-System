        ...
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold mb-1">Gói {planName}</h2>
                  <p className="text-green-100">Trạng thái: Đang hoạt động</p>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      'Test đánh giá không giới hạn',
                      'Xem tất cả nghề nghiệp',
                      'Roadmap đầy đủ 6 levels',
              ...
              {canUpgrade && (
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    ...
                    {showAllPlans ? 'Ẩn tùy chọn nâng cấp' : 'Xem tùy chọn nâng cấp'}
                  </button>
                </div>
              )}
            </div>
          ...
          <div className="mt-8 text-center space-y-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              ...
              <a href="mailto:support@careerbridge.com" className="text-green-600 hover:text-green-700 ml-1">
