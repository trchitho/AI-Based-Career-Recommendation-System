...
def get_education_mapping(job_zone):
    ...
    mappings = {
        1: {
            'en': 'High school diploma or less',
            'vi': 'Tốt nghiệp THPT hoặc thấp hơn'
        },
        2: {
            'en': 'High school diploma plus training',
            'vi': 'Tốt nghiệp THPT cộng với đào tạo'
        },
        3: {
            'en': 'Associate''s degree or equivalent',
            'vi': 'Cao đẳng hoặc tương đương'
        },
        4: {
        ...
        5: {
            'en': 'Master''s degree or higher',
            'vi': 'Thạc sĩ hoặc cao hơn'
        }
    }
...
def get_experience_mapping(job_zone):
    ...
    mappings = {
        ...
        4: {
            'en': 'Considerable preparation needed',
            'vi': 'Cần chuẩn bị đáng kể'
        },
        5: {
            'en': 'Extensive preparation needed',
            'vi': 'Cần chuẩn bị rộng rãi'
        }
    }
    return mappings.get(job_zone, mappings[4])
