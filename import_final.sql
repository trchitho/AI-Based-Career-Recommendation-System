-- Import career_overview data without ID column (let PostgreSQL auto-generate)
-- CSV columns: career_id, experience_text, experience_text_vi, degree_text, degree_text_vi, 
...
-- DB columns:  id (auto), career_id, experience_text_en, experience_text_vn, degree_text_en, degree_text_vn,
