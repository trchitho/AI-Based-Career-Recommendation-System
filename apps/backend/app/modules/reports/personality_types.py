...
PERSONALITY_TYPES: Dict[Tuple[str, str, str, str, str], Dict[str, Any]] = {
    ...
    ("L", "L", "H", "L", "L"): {
        ...
        "strengths": [
            ...
            "Your energy and confidence are contagious. You can motivate others and create excitement around initiatives.",
        ],
        "challenges": [
    ...
    ("L", "L", "L", "L", "H"): {
        ...
        "strengths": [
            ...
            "Your emotional sensitivity keeps you alert to subtle warning signs. You notice when something doesn't feel right.",
    ...
    ("M", "H", "M", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your steady nature makes you a stabilizing presence for teams. Others can count on you during uncertain times.",
        ],
        "challenges": [
    ...
    ("M", "M", "H", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your social energy and confidence inspire others. You create positive momentum in teams and projects.",
        ],
        "challenges": [
    ...
    ("M", "M", "M", "H", "L"): {
        ...
        "strengths": [
            ...
            "Your genuine care for others builds trust and loyalty. People feel valued and supported when working with you.",
        ],
        "challenges": [
    ...
    ("H", "H", "M", "M", "L"): {
        ...
        "challenges": [
            ...
            "Your capability may lead others to over-rely on you. Develop others' capabilities and delegate appropriately.",
        ],
    },
    ...
    ("H", "M", "H", "H", "L"): {
        ...
        "challenges": [
            ...
            "Your optimism may occasionally lead to underestimating obstacles. Build in reality checks and contingency planning.",
        ],
    },
    ...
    ("L", "M", "L", "H", "L"): {
        ...
        "strengths": [
            ...
            "Your emotional stability provides a calming presence. You're not easily rattled by drama or stress.",
        ],
        "challenges": [
    ...
    ("H", "H", "L", "M", "L"): {
        ...
        "strengths": [
            "Your combination of creativity and discipline produces exceptional work. You innovate within rigorous standards.",
    ...
    ("M", "H", "L", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your independence means you're highly productive without supervision. You manage yourself effectively.",
        ],
        "challenges": [
            "Your quiet nature may limit visibility and advancement. Consider strategic ways to share your accomplishments.",
    ...
    ("L", "L", "M", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your realistic approach helps you see situations clearly. You're not distracted by unrealistic expectations.",
        ],
        "challenges": [
    ...
    ("H", "M", "L", "H", "L"): {
        ...
        "strengths": [
            ...
            "Your preference for depth creates genuine, lasting relationships. People trust your authenticity and care.",
            "Your emotional stability allows you to support others calmly. You're a steady presence for those who need you.",
        ],
        "challenges": [
    ...
    ("M", "M", "H", "L", "L"): {
        ...
        "strengths": [
            ...
            "Your assertiveness drives results. You push through obstacles that stop others.",
        ],
        "challenges": [
    ...
    ("H", "M", "H", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your emotional stability allows confident creative risk-taking. You pursue bold ideas without excessive worry.",
            "Your adaptability lets you work in various contexts. You adjust your approach based on audience and situation.",
        ],
        "challenges": [
            "Your many strengths may lead to scattered focus. Consider which opportunities deserve your sustained attention.",
    ...
    ("L", "H", "M", "M", "L"): {
        ...
        "strengths": [
            ...
            "Your emotional stability allows calm problem-solving. You address issues methodically without panic.",
            "Your preference for proven methods ensures consistency. You don't introduce unnecessary risk.",
        ],
        "challenges": [
            "Your preference for proven methods may limit innovation. "
            "Consider when new approaches might yield significant improvements.",
            "Your practical focus may sometimes miss creative possibilities. Build in time to explore unconventional solutions.",
        ],
    },
    ("M", "L", "M", "H", "M"): {
        ...
        "strengths": [
            ...
            "Your emotional sensitivity helps you understand what others are experiencing. You notice when people need support.",
            "Your adaptability allows you to help in various ways. You're not limited to one type of support.",
        ],
        "challenges": [
    ...
    ("H", "H", "M", "L", "L"): {
        ...
        "strengths": [
            ...
            "Your independence allows you to pursue unconventional ideas. You're not constrained by groupthink.",
            "Your emotional stability provides resilience when facing skepticism. You persist despite resistance.",
        ],
        "challenges": [
            "Your independence may limit collaboration and buy-in. Consider when involving others might strengthen your work.",
            "Your directness may sometimes alienate potential supporters. Practice framing ideas in ways that invite engagement.",
        ],
    },
}
...
def _get_default_type(levels: Tuple[str, str, str, str, str]) -> Dict[str, Any]:
    ...
    openness, conscientiousness, extraversion, agreeableness, neuroticism = levels
    ...
    for _i, (level, name) in enumerate(zip(levels, trait_names)):
        if level == "H":
...
def get_personality_type(big5_scores: Dict[str, float]) -> Dict[str, Any]:
    ...
    """
    openness_score = big5_scores.get("openness", 50)
    conscientiousness_score = big5_scores.get("conscientiousness", 50)
    extraversion_score = big5_scores.get("extraversion", 50)
    agreeableness_score = big5_scores.get("agreeableness", 50)
    neuroticism_score = big5_scores.get("neuroticism", 50)

    levels = (
        _get_level(openness_score),
        _get_level(conscientiousness_score),
        _get_level(extraversion_score),
        _get_level(agreeableness_score),
        _get_level(neuroticism_score),
    )
