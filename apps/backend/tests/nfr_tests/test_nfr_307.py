# -*- coding: utf-8 -*-
"""
CareerVerse NFR Verification Suite — File 307
...
def test_rle_roundtrip_nfr_seed3384():
    assert _rle_decode(_rle_encode('aaaaabbc')) == 'aaaaabbc'
