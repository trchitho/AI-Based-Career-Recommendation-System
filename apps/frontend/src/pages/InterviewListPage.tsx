...
import { Search, Play, Loader2, Briefcase, Clock, Users, Eye } from 'lucide-react';
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div className="p-6">
                                {jobs.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative" style={{ overflow: 'visible' }}>
                                        {jobs.map((job) => (
                                            <div
                                                key={job.id}
                                                className="border border-gray-200 rounded-xl p-5 hover:border-blue-300 hover:shadow-lg transition-all duration-200 group relative bg-gradient-to-br from-white to-gray-50"
                                                style={{ overflow: 'visible', position: 'relative' }}
                                            >
                                                <div className="flex items-start justify-between mb-4">
                                                    <div className="flex-1 min-w-0">
                                                        <h3
                                                            className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors cursor-help truncate text-lg"
                                                            title={job.description_vi || job.title}
                                                        >
                                                            {job.title}
                                                        </h3>
                                                        ...
                                                        {job.description_vi && (
                                                            <div className="absolute left-1/2 top-full mt-2 w-96 max-w-sm bg-gray-900 text-white text-sm rounded-xl px-4 py-3 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none shadow-2xl transform -translate-x-1/2 translate-y-2 group-hover:translate-y-0"
                                                                style={{ zIndex: 99999 }}>
                                                                <div className="font-semibold mb-2 text-blue-300">{job.title}</div>
                                                ...
                                                <div className="flex gap-3">
                                                    <button
                                                        onClick={() => navigate(`/interview/select/${job.id}`)}
                                                        className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-200 flex items-center justify-center gap-2 shadow-sm"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex-1 bg-gray-100 text-gray-700 px-4 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-all duration-200 flex items-center justify-center gap-2"
                                                    >
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                if (firstJob) navigate(`/interview/select/${firstJob.id}`);
                                            }}
                                    ...
                                    <>
                                        <div className="space-y-4">
                                            {(showAllInterviews ? allInterviews : recentInterviews).map((interview) => (
                                                <div
                                                    key={interview.id}
                                                    className="border border-gray-200 rounded-xl p-4 hover:border-blue-300 hover:shadow-md transition-all duration-200 cursor-pointer group relative"
                                                ...
                                                >
                                                    ...
                                                    {/* Enhanced Hover Tooltip with Detailed Scores */}
                                                    {interview.overall_score && (
                                                        <div className="absolute left-1/2 bottom-full mb-2 w-80 bg-gray-900 text-white text-xs rounded-xl px-4 py-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none shadow-xl transform -translate-x-1/2"
                                                            style={{ zIndex: 99999 }}>
                                                            <div className="font-semibold mb-2 text-blue-300">Điểm chi tiết</div>
                                                            <div className="space-y-2">
                                                                <div className="flex justify-between">
                                                                    <span className="text-gray-300">Điểm tổng:</span>
                                                                    <span className="text-blue-300 font-medium">{interview.overall_score.toFixed(1)}/10</span>
                                                                </div>
                                                                <div className="flex justify-between">
                                                                    <span className="text-gray-300">Kết quả:</span>
                                                                    <span className={`font-medium ${interview.recommendation === 'PASS' ? 'text-green-300' :
                                                                        interview.recommendation === 'CONDITIONAL_PASS' ? 'text-yellow-300' :
                                                                            'text-red-300'
                                                                        }`}>
                                                            ...
                                                            <div className="mt-2 pt-2 border-t border-gray-700">
                                                                <div className="text-gray-400 text-xs">Phân tích kỹ năng theo từng tiêu chí</div>
                                                                <div className="text-blue-300 text-xs mt-1">Nhấn để xem chi tiết →</div>
                                                            </div>
                                                            {/* Arrow */}
