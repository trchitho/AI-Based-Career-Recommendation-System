    ...
    return (
        <section className="mt-32 bg-gradient-to-r from-[E8DCC8] to-[D4C4B0] dark:from-gray-800 dark:to-gray-700 rounded-3xl border border-gray-300 dark:border-gray-600 p-12 text-center shadow-xl">
            ...
            <Link
                ...
                className="inline-block px-10 py-5 bg-primary-cta dark:bg-indigo-800 text-white rounded-xl font-bold text-xl hover:bg-primary-dark dark:hover:bg-indigo-900 transition-all duration-200 shadow-xl"
            >
