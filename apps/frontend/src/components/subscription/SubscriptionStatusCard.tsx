        ...
        <div className="flex items-center justify-between">
          ...
          {isPremium && (
            <div className="text-right">
              <span className="inline-flex items-center gap-1 px-2 py-1 bg-indigo-50 dark:bg-indigo-950/30 text-indigo-900 dark:text-indigo-300 text-xs font-semibold rounded-full">
      ...
      <div className="p-6">
        {isPremium ? (
          <div className="text-center py-4">
            <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-950/30 rounded-full flex items-center justify-center mx-auto mb-2">
