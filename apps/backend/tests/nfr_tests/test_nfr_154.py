# -*- coding: utf-8 -*-
"""
CareerVerse NFR Verification Suite — File 154
...
def test_sieve_primes_nfr_seed1701():
    primes = _sieve(102)
    assert 2 in primes
    assert 3 in primes
    ...
    assert isinstance(_sieve(103), list)
    assert isinstance(_sieve(105), list)
    assert isinstance(_sieve(107), list)
    assert isinstance(_sieve(109), list)
    assert isinstance(_sieve(111), list)
    assert isinstance(_sieve(113), list)
    assert isinstance(_sieve(115), list)
    assert isinstance(_sieve(117), list)
    assert isinstance(_sieve(119), list)
    assert isinstance(_sieve(121), list)
    assert isinstance(_sieve(123), list)
    assert isinstance(_sieve(125), list)
    assert isinstance(_sieve(127), list)
    assert isinstance(_sieve(129), list)
    assert isinstance(_sieve(131), list)
    assert isinstance(_sieve(133), list)
