...
const OAuthCallbackPage = () => {
  ...
  const BrandLogo = () => (
    <div className="flex items-center gap-0.5 select-none group animate-pulse">
      ...
      <span className="text-3xl font-extrabold tracking-tight text-indigo-800 dark:text-indigo-700">bridge</span>
      <span className="text-4xl font-extrabold text-indigo-800 dark:text-indigo-700 leading-none mb-1">.</span>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-surface-primary dark:bg-gray-900 text-gray-900 dark:text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-700/5 rounded-full blur-[100px] pointer-events-none z-0 animate-pulse"></div>
