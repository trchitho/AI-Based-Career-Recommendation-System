          ...
          <div className="animate-fade-in-up">
            ...
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4 tracking-tight">
                Preparing Your <span className="text-indigo-800 dark:text-indigo-700">Assistant</span>
              </h1>
                ...
                <div className="bg-gray-50 dark:bg-gray-900/50 rounded-card-special p-8 md:p-10">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                      <svg className="w-5 h-5 text-indigo-800" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                  ...
                  <div className="mt-8 flex justify-end items-center gap-4">
                    ...
                    <button
                      onClick={proceed}
                      className="group px-8 py-3.5 bg-indigo-800 hover:bg-indigo-900 text-white rounded-xl font-bold shadow-lg shadow-indigo-900/20 hover:shadow-indigo-900/40 hover:-translate-y-0.5 transition-all flex items-center gap-2"
                    >
                      Start Assistant
