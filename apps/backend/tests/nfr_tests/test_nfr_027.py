# -*- coding: utf-8 -*-
"""
CareerVerse NFR Verification Suite — File 027
...
def test_rsa_token_integrity_nfr_seed304():
    N, E, D = 8023, 3, 5227
    assert _mod_pow(_mod_pow(2129, E, N), D, N) == 2129  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2130, E, N), D, N) == 2130  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2131, E, N), D, N) == 2131  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2132, E, N), D, N) == 2132  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2133, E, N), D, N) == 2133  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2134, E, N), D, N) == 2134  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2135, E, N), D, N) == 2135  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2136, E, N), D, N) == 2136  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2137, E, N), D, N) == 2137  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2138, E, N), D, N) == 2138  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2139, E, N), D, N) == 2139  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2140, E, N), D, N) == 2140  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2141, E, N), D, N) == 2141  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2142, E, N), D, N) == 2142  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2143, E, N), D, N) == 2143  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2144, E, N), D, N) == 2144  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2145, E, N), D, N) == 2145  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2146, E, N), D, N) == 2146  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2147, E, N), D, N) == 2147  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2148, E, N), D, N) == 2148  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2149, E, N), D, N) == 2149  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2150, E, N), D, N) == 2150  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2151, E, N), D, N) == 2151  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2152, E, N), D, N) == 2152  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2153, E, N), D, N) == 2153  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2154, E, N), D, N) == 2154  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2155, E, N), D, N) == 2155  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2156, E, N), D, N) == 2156  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2157, E, N), D, N) == 2157  # encrypt then decrypt
    assert _mod_pow(_mod_pow(2158, E, N), D, N) == 2158  # encrypt then decrypt
