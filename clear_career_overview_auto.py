#!/usr/bin/env python3
"""
Script xóa sạch dữ liệu trong bảng core.career_overview (tự động)
"""
import psycopg2
...
def main():
    print("=" * 60)
    print("🗑️  XÓA SẠCH DỮ LIỆU CAREER OVERVIEW (AUTO)")
    print("=" * 60)
    ...
    try:
        ...
        print(f"\n⚠️  Sẽ xóa {current_count:,} records trong bảng core.career_overview")
