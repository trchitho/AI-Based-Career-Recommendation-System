                                    ...
                                    {jobs.length === 0 ? (
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            {jobs.map((job) => (
                                                <div
                                                    key={job.id}
                                                    className="border border-gray-200 rounded-xl p-5 hover:border-blue-300 hover:shadow-lg transition-all duration-200 group bg-gradient-to-br from-white to-gray-50 flex flex-col h-[280px]"
                                                >
                                                    {/* Content Area - Flex grow để chiếm hết không gian */}
                                                    <div className="flex-1 flex flex-col">
                                                        <div className="flex items-start justify-between mb-4">
                                                            <div className="flex-1 min-w-0">
                                                                <h3 className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors text-lg mb-2 line-clamp-2">
                                                                    {job.title}
                                                                </h3>
                                                        ...
                                                        <div className="flex-1 mb-4">
                                                            {job.description_vi && (
                                                                <div
                                                                    className="text-sm text-gray-600 leading-relaxed h-[90px] overflow-hidden"
                                                                    style={{
                                                                        display: '-webkit-box',
                                                                        WebkitLineClamp: 4,
