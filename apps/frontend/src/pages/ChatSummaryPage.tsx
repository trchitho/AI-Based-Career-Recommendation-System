      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {!loading && !error && (
          <>
            ...
            <textarea className="w-full border rounded px-3 py-2 h-64 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200" value={summary} onChange={(e)=>setSummary(e.target.value)} />
            <div className="mt-4 flex justify-end">
              <button onClick={proceed} className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700">Start Chat</button>
            </div>
          </>
        )}
      </div>
