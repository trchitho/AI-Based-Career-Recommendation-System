...
const Big5Cover = ({ cover }: Big5CoverProps) => {
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="bg-gradient-to-r from-purple-700 to-indigo-800 text-white px-10 py-6 -mx-10 -mt-10 mb-6 print:-mx-[15mm] print:-mt-[15mm] print:px-[15mm] print:py-5 print:mb-4">
                {/* Title Row */}
                <h1 className="text-2xl font-extrabold mb-2 print:text-xl">
                    {cover.title}
                </h1>
                {cover.subtitle && (
                    <p className="text-purple-200 text-base print:text-sm mb-3">
                        {cover.subtitle}
                    </p>
                )}
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 border-t border-purple-500/30 pt-3 mt-2">
                    ...
                    {cover.completed_at && (
                        <p className="text-purple-200 text-base print:text-sm">
