...
def main():
    ...
    try:
        ...
        if encoding_issues == 0:
            print("  ✅ Vietnamese encoding: No issues found")
        else:
        ...
        if empty_titles == 0:
            print("  ✅ Career titles: All careers have Vietnamese titles")
        else:
        ...
        if zero_riasec == 0:
            print("  ✅ RIASEC scores: All careers have valid RIASEC scores")
        else:
        ...
        if riasec_avg:
            print("  📊 RIASEC averages:")
            labels = ["Realistic", "Investigative", "Artistic", "Social", "Enterprising", "Conventional"]
            for _i, (label, avg) in enumerate(zip(labels, riasec_avg)):
        ...
        if not issues:
            print("  🎉 ETL Pipeline Status: EXCELLENT")
            print("     All data loaded successfully with no issues detected")
        else:
            print("  ⚠️  ETL Pipeline Status: GOOD with minor issues")
            print("     Issues found:")
            for issue in issues:
                print(f"     - {issue}")
