...
-- ============================
-- Add like/dislike functionality to blog posts

-- Add reaction counts to blog_posts table
...
-- Create trigger to automatically update reaction counts
...
CREATE TRIGGER trg_update_blog_post_reaction_counts
    ...
    FOR EACH ROW
    EXECUTE FUNCTION update_blog_post_reaction_counts();

-- Initialize existing posts with zero counts (if not already set)
UPDATE core.blog_posts 
...
UNION ALL
SELECT 
    'blog_post_reactions' as table_name,
