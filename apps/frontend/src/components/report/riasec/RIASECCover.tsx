...
const RIASECCover = ({ cover }: RIASECCoverProps) => {
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="bg-gradient-to-r from-green-600 to-teal-700 text-white px-10 py-5 -mx-10 -mt-10 mb-6 print:-mx-[15mm] print:-mt-[15mm] print:px-[15mm] print:py-4 print:mb-4">
                {/* Title Row */}
                <h1 className="text-xl font-extrabold mb-1 print:text-lg">
                    {cover.title}
                </h1>
                {cover.subtitle && (
                    <p className="text-green-100 text-sm print:text-xs mb-3">
                        {cover.subtitle}
                    </p>
                )}
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 border-t border-green-500/30 pt-3 mt-2">
                    ...
                    {cover.completed_at && (
                        <p className="text-green-100 text-sm print:text-xs">
