        ...
        <div className="w-full max-w-[480px] animate-fade-in-up">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl shadow-gray-200/40 dark:shadow-none border border-gray-100 dark:border-gray-700 p-8 sm:p-10 relative">
            <form className="space-y-6" onSubmit={submit}>
              ...
              {/* Messages */}
              {done && (
                <div className="rounded-xl bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-200 dark:border-indigo-800 p-4 text-sm text-center">
                  ...
                  <p className="text-indigo-950 dark:text-indigo-300 font-bold text-lg mb-1">Verified!</p>
