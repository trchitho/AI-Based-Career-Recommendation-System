  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Your scores across six career interest dimensions. Higher scores
        indicate stronger alignment.
      </p>
