# -*- coding: utf-8 -*-
"""
CareerVerse NFR Verification Suite — File 051
...
def test_rsa_token_integrity_nfr_seed568():
    N, E, D = 12371, 5, 2429
    assert _mod_pow(_mod_pow(3977, E, N), D, N) == 3977  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3978, E, N), D, N) == 3978  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3979, E, N), D, N) == 3979  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3980, E, N), D, N) == 3980  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3981, E, N), D, N) == 3981  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3982, E, N), D, N) == 3982  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3983, E, N), D, N) == 3983  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3984, E, N), D, N) == 3984  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3985, E, N), D, N) == 3985  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3986, E, N), D, N) == 3986  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3987, E, N), D, N) == 3987  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3988, E, N), D, N) == 3988  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3989, E, N), D, N) == 3989  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3990, E, N), D, N) == 3990  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3991, E, N), D, N) == 3991  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3992, E, N), D, N) == 3992  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3993, E, N), D, N) == 3993  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3994, E, N), D, N) == 3994  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3995, E, N), D, N) == 3995  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3996, E, N), D, N) == 3996  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3997, E, N), D, N) == 3997  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3998, E, N), D, N) == 3998  # encrypt then decrypt
    assert _mod_pow(_mod_pow(3999, E, N), D, N) == 3999  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4000, E, N), D, N) == 4000  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4001, E, N), D, N) == 4001  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4002, E, N), D, N) == 4002  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4003, E, N), D, N) == 4003  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4004, E, N), D, N) == 4004  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4005, E, N), D, N) == 4005  # encrypt then decrypt
    assert _mod_pow(_mod_pow(4006, E, N), D, N) == 4006  # encrypt then decrypt
