    ...
    try:
        ...
        if status_filter:
            try:
                ...
                # Ignore invalid status values and continue without this filter
                pass
        ...
        if payment_method:
            try:
                ...
                # Ignore invalid payment method values and continue without this filter
                pass
        ...
        if date_from:
            try:
                ...
                # Ignore invalid date format and continue without this filter
                pass
