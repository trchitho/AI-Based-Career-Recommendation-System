                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="text-center mb-16 animate-fade-in-up">
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight leading-tight">
                            Explore <span className="text-green-600 dark:text-green-500">Careers</span>
                        </h1>
                        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto font-medium leading-relaxed mb-10">
                            {data?.group.description || `Discover career opportunities in ${data?.group.name || actualGroupSlug}. Find roles that match your skills and interests.`}
                        </p>
                        ...
                        <div className="max-w-2xl mx-auto relative group">
                            ...
                            <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl flex items-center p-2 border border-gray-100 dark:border-gray-700">
                                ...
                                <input
                                    ...
                                    placeholder="Search careers in this field..."
                    ...
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-32 animate-pulse">
                            ...
                            <p className="text-gray-500 font-medium">Loading careers...</p>
                        </div>
                            ...
                            {data.items.map((career, index) => {
                                ...
                                const CardContent = (
                                    <div className={`group bg-white dark:bg-gray-800 rounded-card-hero border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/50 dark:shadow-none hover:shadow-2xl hover:shadow-green-900/10 hover:-translate-y-2 transition-all duration-slow flex flex-col overflow-hidden h-full relative ${isLocked ? 'opacity-75' : ''}`}>
                                        ...
                                        {/* Image Placeholder */}
                                        <div className={`h-32 bg-gradient-to-br ${bgGradient} flex items-center justify-center relative overflow-hidden`}>
                                            <div className={`absolute inset-0 ${isLocked ? 'bg-black/30' : 'bg-black/10 group-hover:bg-black/0'} transition-all duration-500`}></div>

                                            {/* Icon */}
                                            <div className={`relative z-10 w-12 h-12 ${isLocked ? 'bg-white/10' : 'bg-white/20'} backdrop-blur-md rounded-xl flex items-center justify-center border border-white/30 text-white shadow-lg ${!isLocked ? 'group-hover:scale-110' : ''} transition-transform duration-300`}>
                                                {isLocked ? (
                                                ...
                                                {isLocked
                                                    ? (() => {
                                                        if (currentPlan === 'free') {
                                                            const canView = canUseFeature('career_view');
                                                            if (!canView) {
                                                                return `Upgrade to Basic Plan (99k) to view this career.`;
                                                            } else {
                                                                return `Upgrade to Basic Plan (99k) to view more careers.`;
                                                            }
                                                        } else if (currentPlan === 'basic') {
                                                            return `Upgrade to Premium Plan (199k) for unlimited access.`;
                                                        } else {
                                                            return `Upgrade to ${requiredPlanInfo?.name || 'Premium'} to view this career.`;
                                                        }
                                                    })()
                                                    : (career.short_desc || career.description || 'Explore this exciting career path and see if it fits your profile.')
                                                }
                                            </p>
                                        ...
                                        state={{
                                            ...
                                            message: currentPlan === 'free'
                                                ? (canUseFeature('career_view')
                                                    ? `Upgrade to Basic Plan to view this career.`
                                                    : `You have used all free career views. Upgrade to view more.`)
                        ...
                        <div className="text-center py-32 animate-fade-in-up">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-8">
                                {q ? `We couldn't find any careers matching "${q}" in this field.` : 'No careers available in this field.'}
                            </p>
                            {q && (
                                <button
                                    onClick={() => setQ('')}
